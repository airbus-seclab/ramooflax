...
# Test case: mixing data/insn hrd breakpoints
...
vm.cpu.breakpoints.add_data_w(vm.cpu.gpr.ebp-4, 4, name="data")
vm.resume()

vm.cpu.breakpoints.remove("data")

vm.cpu.breakpoints.add_hw_insn(0x2000b4, name="insn")
vm.resume()

if vm.cpu.gpr.pc == 0x2000b4:
    print "success"
else:
    print "failure"
