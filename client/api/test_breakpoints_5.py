...
# Test case: hardware data breakpoints
...
vm.cpu.breakpoints.add_data_rw(vm.cpu.gpr.ebp - 4, 4)
vm.resume()

if vm.cpu.gpr.eip == 0x2000a8:
    vm.resume()
    if vm.cpu.gpr.eip == 0x2000b7:
        print "success"
