...
# Test case: multiple breakpoints/single-step add/remove
...
vm.cpu.breakpoints.add_insn(0x2000a2)
vm.resume()

vm.singlestep()
vm.cpu.breakpoints.add_hw_insn(0x2000b4)
vm.resume()
vm.singlestep()
vm.singlestep()
